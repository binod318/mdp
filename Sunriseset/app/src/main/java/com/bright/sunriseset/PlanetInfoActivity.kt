...
class PlanetInfoActivity : AppCompatActivity() {
        ...
        GlobalScope.launch(Dispatchers.Main) {
            ...
            if (sunriseTime != null && sunsetTime != null) {
                ...
                binding.textViewSunrise.text =
                    "${getString(R.string.SunriseTime)} $localizedSunrise ${getString(R.string.am)}"
                binding.textViewSunset.text =
                    "${getString(R.string.SunsetTime)} $localizedSunset ${getString(R.string.pm)}"
            }
        }
    }
    ...
    private fun getLocalizedTime(time: LocalDateTime, context: Context): String {
        ...
        val sdf = SimpleDateFormat("hh:mm", Locale(userPreferredLanguage))
